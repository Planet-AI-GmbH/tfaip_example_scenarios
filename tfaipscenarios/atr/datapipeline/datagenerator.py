...
from tfaip.base import DataGeneratorParams, Sample
...
class ATRDataGenerator(DataGenerator[ATRDataGeneratorParams]):
    ...
    def generate(self) -> Iterable[Sample]:
        return (Sample(inputs=fn, targets=split_all_ext(fn)[0] + '.gt.txt', meta={'filename': fn}) for fn in
                self.params.image_files)
