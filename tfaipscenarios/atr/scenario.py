...
from tfaipscenarios.atr.model import ATRModelParams, ATRModel
from tfaipscenarios.atr.params import ATRDataParams, ATRTrainerPipelineParams
...
class ATRScenario(ScenarioBase[ATRData, ATRModel, ATRScenarioParams, ATRTrainerPipelineParams]):
    @classmethod
